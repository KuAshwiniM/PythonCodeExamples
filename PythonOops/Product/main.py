...
def main():
    ...
    # 3. Demonstration of Successful Purchases & Stock Updates
    ...
    # 4. Demonstration of Restocking Inventory
    ...
    # 5. Demonstration of Exception Handling (Insufficient Stock)
    ...
    # 6. Demonstration of Static Method Usage
